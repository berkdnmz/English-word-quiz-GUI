...
class Game():
    def __init__(self):
        ...
        self.total_wrong = 0
        self.score = 0
        self.game_screen.initialize_game_gui()
        self.game_screen.run_root()

    def select_word(self):
        self.selected_words = random.sample(list(self.word_manager.words.keys()), k=10)
